import{e as B,r as R,n as z,w as Z,v as q,h as t,Y as G,d as y,l as ie,a as f,Z as ne,b as w,m as N,$ as se,a0 as ae,a1 as le,a2 as H,T as ce,a3 as de,a4 as ue,a5 as pe,u as V,f as M,a6 as fe,a7 as ge,z as me,a8 as K,A as Y,B as X,a9 as he,aa as ve,ab as be,ac as xe,p as ye,c as we,i as _e,ad as $e,ae as Q,af as J,ag as ee,ah as te,ai as re,q as I,aj as ke,D as W,E as D,F as r,_ as Ce,L as b,M as x,R as ze,P as j,N as Se,ak as Pe,U as Be,X as Re,al as Ne,am as Oe,an as De,Q as L,ao as Ie,V as je}from"./index-DIU70qs1.js";import{T as Te,A as We}from"./TrashOutline-Drej7mKC.js";import{N as Me}from"./Input-CCU3zx3s.js";import{_ as Ee}from"./Checkbox-B1_p77GY.js";const F=B({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const i=R(null),o=R(e.value),m=R(e.value),a=R("up"),n=R(!1),c=z(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${a.value}-scroll`:null),d=z(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${a.value}-scroll`:null);Z(q(e,"value"),(u,p)=>{o.value=p,m.value=u,G(s)});function s(){const u=e.newOriginalNumber,p=e.oldOriginalNumber;p===void 0||u===void 0||(u>p?h("up"):p>u&&h("down"))}function h(u){a.value=u,n.value=!1,G(()=>{var p;(p=i.value)===null||p===void 0||p.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:u}=e;return t("span",{ref:i,class:`${u}-base-slot-machine-number`},o.value!==null?t("span",{class:[`${u}-base-slot-machine-old-number ${u}-base-slot-machine-old-number--top`,d.value]},o.value):null,t("span",{class:[`${u}-base-slot-machine-current-number`,c.value]},t("span",{ref:"numberWrapper",class:[`${u}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${u}-base-slot-machine-current-number__inner--not-number`]},m.value)),o.value!==null?t("span",{class:[`${u}-base-slot-machine-old-number ${u}-base-slot-machine-old-number--bottom`,d.value]},o.value):null)}}}),{cubicBezierEaseOut:T}=ie;function qe({duration:e=".2s"}={}){return[y("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${T},
 max-width ${e} ${T},
 transform ${e} ${T}
